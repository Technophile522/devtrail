# Reglas para Agentes IA - Enigmora Chronicle Framework

> Este documento define las reglas que todos los agentes de IA deben seguir cuando trabajan en proyectos bajo Chronicle Framework.
...
```
.chronicle/templates/TEMPLATE-[TIPO].md
```
...
| Tipo | Carpeta |
|------|---------|
| AILOG | `.chronicle/07-ai-audit/agent-logs/` |
| AIDEC | `.chronicle/07-ai-audit/decisions/` |
| ETH | `.chronicle/07-ai-audit/ethical-reviews/` |
| ADR | `.chronicle/02-design/decisions/` |
| REQ | `.chronicle/01-requirements/` |
| TES | `.chronicle/04-testing/` |
| INC | `.chronicle/05-operations/incidents/` |
| TDE | `.chronicle/06-evolution/technical-debt/` |
