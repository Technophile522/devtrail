# Rules for AI Agents - Enigmora Chronicle Framework

> This document defines the rules that all AI agents must follow when working on projects under Chronicle Framework.
...
```
.chronicle/templates/TEMPLATE-[TYPE].md
```
